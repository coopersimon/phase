...
- Crash Bandicoot: Mostly ok, lighting on certain things looks totally wrong, eventually crashes with a reverb mem issue.
- Crash Bandicoot 2: Boots, startup looks kinda ok, a bit choppy FPS, some lighting issues, sound cuts out in intro scene
- Crash Bandicoot 3: Boots, looks ok with some flickering (choppy FPS), eventually crashes with reverb mem issue
...
- Resident Evil 2: Starts OK, lighting issues, intro video locks up sometimes
