    ...
    fn send_gp0_command(&mut self, data: u32) {
        ...
        if self.pending_command_words == 0 {
            ...
            let gp0_command = match self.pending_command {
                ...
                0x34 => Some(DrawTexShadedTri{params: std::array::from_fn(|n| self.command_data[n]), transparent: false}),
                0x36 => Some(DrawTexShadedTri{params: std::array::from_fn(|n| self.command_data[n]), transparent: true}),
                ...
                0x3C => Some(DrawTexShadedQuad{params: std::array::from_fn(|n| self.command_data[n]), transparent: false}),
                0x3E => Some(DrawTexShadedQuad{params: std::array::from_fn(|n| self.command_data[n]), transparent: true}),
                ...
                0x50 => Some(DrawShadedLine{params: std::array::from_fn(|n| self.command_data[n]), transparent: false}),
                0x52 => Some(DrawShadedLine{params: std::array::from_fn(|n| self.command_data[n]), transparent: true}),
                0x58 => self.shaded_poly_line(false),
                0x5A => self.shaded_poly_line(true),
